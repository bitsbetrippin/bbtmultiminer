...
__kernel void bmw(__global uint* hashes)
{
    ...
    hash->h4[0].x = final_s[8];
    hash->h4[0].y = final_s[9];
    hash->h4[0].z = final_s[10];
    hash->h4[0].w = final_s[11];
    hash->h4[1].x = final_s[12];
    hash->h4[1].y = final_s[13];
